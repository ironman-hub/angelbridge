        ...
        <div className="grid gap-10 lg:grid-cols-2 lg:items-center">
          <div>
            ...
            <p className="mt-4 text-slate-600">
              ...
              anywhere, at any time — a breakdown, a cancelled last train, a lost wallet, a housing crisis. The
              right services often exist, but there&apos;s a gap between when help is needed and when it arrives
              that could be detrimental.
            </p>
            <p className="mt-3 text-slate-600">
              We live and breathe to fill that gap. We provide immediate, practical support during the waiting
              period and connect people to the longer-term help they need — starting in Manchester, one
              community at a time, and going beyond.
            </p>
      ...
      <section className="bg-white">
        <div className="section py-16">
          ...
          <div className="mt-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            ...
            <div className="card flex flex-col border-2 border-brand-200 p-5">
